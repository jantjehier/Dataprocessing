...
for(var j = 0; j < 248; j++)
{
  ...
  for (var i = 0; i < data.length; i++)
  {
    ...
    {
      // if the Area is smaller than 1000, between 1000 and 2000 etc.
      // the fillkey of the data is one, two, ... rest.
      if (data[i].Area < 1000)
      {
        fillkey = 'one';
      }
      else if(data[i].Area < 2000)
      {
        fillkey = 'two';
      }
      else if(data[i].Area < 3000)
      {
        fillkey = 'three';
      }
      else if(data[i].Area < 4000)
      {
        fillkey = 'four';
      }
      else if(data[i].Area < 5000)
      {
        fillkey = 'five';
      }
      else if(data[i].Area < 6000)
      {
        fillkey = 'six';
      }
      else if(data[i].Area < 7000)
      {
        fillkey = 'seven';
      }
      else if(data[i].Area < 8000)
      {
        fillkey = 'eight';
      }
      else if(data[i].Area < 9000)
      {
        fillkey = 'nine';
      }
      else if(data[i].Area < 10000)
      {
        fillkey = 'ten';
      }
      else
...
$("#container").datamap({
   ...
   geography_config: {
     ...
     popupTemplate: _.template([
       ...
       '<% if (data.value) { %>',
       '<small>Area: <%= data.value %> km2<% } %><small>',
       '</div>'
      ].join('') )
   },
